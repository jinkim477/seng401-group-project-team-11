...
export default function DietOptionsPage() {
    ...
    const handleDietSelection = (selectedDiet: string, selectedDiets: string[]) => {
        const incompatibleDiets = {
            'Vegan': ['Pescatarian', 'Keto', 'Paleo'],
            'Vegetarian': ['Pescatarian', 'Keto', 'Paleo'],
            'Pescatarian': ['Vegan', 'Vegetarian'],
            'Keto': ['Vegan', 'Vegetarian', 'DASH', 'Mediterranean'],
            'Paleo': ['Vegan', 'Vegetarian'],
            'DASH': ['Keto'],
            'Mediterranean': ['Keto']
        };

        if (selectedDiet in incompatibleDiets) {
            return selectedDiets.filter(diet => !incompatibleDiets[selectedDiet].includes(diet));
        }
    ...
    const handleCheckboxChange = (
        ...
        setFormData((prev) => {
            ...
            // Handle incompatible diets
            if (category === "selectedDiets") {
                updatedGoals = handleDietSelection(value, updatedGoals);
            }
