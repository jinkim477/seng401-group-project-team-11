                    ...
                    {loading ? (
                        ...
                        <div className="space-y-6">
                            {mealHistory.map((meal) => {
                                ...
                                return (
                                    <div key={meal.id} className="bg-primary dark:bg-dark text-dark dark:text-primary p-6 rounded-xl shadow-md">
                                        <h3
                                            className="text-lg font-semibold cursor-pointer"
                                            onClick={() => toggleMealPlan(meal.id)}
                                        >
                                            📅 Generated on: {new Date(meal.createdTime).toLocaleString()}
                                        </h3>
                                        {isExpanded && (
                                            <>
                                                        ...
                                                        {Object.entries(meals).map(([mealType, mealData]) => {
                                                            ...
                                                            return (
                                                                <div key={mealType} className="mb-6 p-4 rounded-lg bg-accent-green dark:bg-accent-green text-dark">
                                                                    ...
                                                                    <p className="">{mealData.instructions || "No instructions provided."}</p>
                                                                    ...
                                                                    {mealData.macros ? (
                                                                        <>
                                                                            ...
                                                                            <ul className="list-disc pl-5">
                                                                                <li>Calories: {mealData.macros.calories || "N/A"}</li>
                                                                                <li>Protein: {mealData.macros.protein || "N/A"}</li>
                                                                                <li>Carbs: {mealData.macros.carbs || "N/A"}</li>
                                                                                <li>Fat: {mealData.macros.fat || "N/A"}</li>
                                                                            </ul>
                                                                        </>
                                                                    ) : (
