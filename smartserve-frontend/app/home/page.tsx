	...
	return (
		<div className="relative min-h-screen bg-primary text-dark dark:bg-dark dark:text-primary flex flex-col items-center px-4 py-6 lg:px-8 lg:py-4 overflow-hidden">
			<div className="w-full flex flex-col lg:flex-row justify-between items-center">
				...
				{/* Dark Mode Toggle */}
				<div className="lg:mt-4 lg:mt-0 justify-end">
					<ThemeToggle />
				</div>
			</div>
			<div className="w-full flex flex-col lg:flex-row justify-between lg:justify-start lg:mt-16">
				<div className="w-full lg:w-1/3 flex flex-col lg:justify-center items-center lg:mt-12">
				...
				<div className="w-full lg:h-full lg:w-1/4 flex flex-col mt-6 lg:mt-0 lg:space-y-24 justify-center items-center lg:items-start">
